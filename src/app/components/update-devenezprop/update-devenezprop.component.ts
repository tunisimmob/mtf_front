...
@Component({
  selector: 'app-update-devenezprop',
  templateUrl: './update-devenezprop.component.html',
  styleUrls: ['./update-devenezprop.component.css']
})
export class UpdateDevenezpropComponent implements OnInit {

  id: number;
  devenezprop: Devenezproprietaire;
  testimage: string;
  ...
  ngOnInit() {
    ...
    this.DataService.getDevenezProprietaire(this.id).subscribe(
      (data) => {
        console.log(data);
        this.devenezprop = data;
      },
  ...
  onSubmit() {
    this.DataService.updateDevenezProprietaire(this.devenezprop).subscribe(
      (data) => {
        console.log(data);
        this.devenezprop = new Devenezproprietaire();
